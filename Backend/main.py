...
evt = Evento()
pjt = Projeto()
#pjt.deletaProjeto(1, 'teste')
#pjt.criaProjeto(1, 'teste', 23445, '2023-07-29', 'teste', 'teste', 'teste', 'teste')
#print(pjt.getEspecificacaoProjeto(1, 'teste'))
pjt.setNomeProjeto('teste2', 1, 'teste')
db = Database()
db.connect()
